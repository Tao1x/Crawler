...
public class Config {
    ...
    public static final String HOT_CURRENT = "http://www.91porn.com/v" +
        ".php?category=hot&viewtype=basic";

    public static final String TOP_HOT_LAST_MONTH = "http://www.91porn.com/v" +
        ".php?category=top&m=-1&viewtype=basic";

    public static final String[] PAGES = new String[]{HOME_PAGE, TOP_HOT, TOP_STORE, HOT_CURRENT,
        TOP_HOT_LAST_MONTH};
